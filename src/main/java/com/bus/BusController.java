...
//	Login process
	...
	public String login(@RequestParam("email") String email, @RequestParam("password") String password,
		...
		if (object != null) {
			...
			if (email.equals("kabil123@gmail.com") && password.equals("1234")) {
				return "addmovie";
			}
...
public String addScreen(@RequestParam("movieName") String movieName,@RequestParam("screen") String screen,
		  @RequestParam("movieDetails") String movieDetails,@RequestParam("image") String image,
			 Model m) {
	MovieDetails movie = new MovieDetails();
    movie.setMovieName(movieName);
    movie.setScreen(screen);
    movie.setMovieDescription(movieDetails);
